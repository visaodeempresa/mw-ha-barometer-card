...
REPO = "visaodeempresa/mw-ha-barometer-card"          # dono/repositório no GitHub
NOME = "mw-ha-barometer-card"                    # a pasta em /config/www/community
CARD = "mw-barometer-card"                    # o arquivo .js, sem extensão
